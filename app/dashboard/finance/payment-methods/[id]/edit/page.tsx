    ...
    const fetchPaymentMethod = async () => {
      ...
      try {
        ...
        const mockData = {
          ...
          displayOrder: '3',
          accountMappings: [
            { currency: 'EGP', accountId: '1', accountName: 'CIB - EGP Main Account' }
          ],
          provider: '',
          apiKeyId: '',
          isLive: false,
          instructionsEn: 'Transfer to:\nBank: CIB\nAccount: 1234567890\nPlease include invoice number in the reference.',
          instructionsAr: 'التحويل إلى:\nالبنك: CIB\nالحساب: 1234567890\nيرجى تضمين رقم الفاتورة في المرجع.',
          logoUrl: ''
        }
        ...
        <div className="mb-6 bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-yellow-300">
              <p>
                <strong className="text-yellow-400">Note:</strong> Changes to account mappings will only affect new transactions. Existing transactions remain unchanged.
              </p>
            </div>
          </div>
        </div>

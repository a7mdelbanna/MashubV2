...
export default function EditCategoryPage({ params }: { params: { id: string } }) {
  ...
  // Filter parent categories by selected type, excluding self and descendants
  const filteredParentCategories = existingCategories.filter(cat =>
    cat.type === formData.type && cat.id !== params.id
  )
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.parentId === params.id) {
    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Modify category details and budget settings
        </p>
      </div>
        ...
        <div className="mb-6 bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-yellow-300">
              <p className="mb-2">
                <strong className="text-yellow-400">Important:</strong> Changing the parent category or type will affect the category path used in existing transactions.
              </p>
              <p>
                Historical transactions will keep their original category reference, but the path display will be updated.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-700 p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1">Leave empty to remove budget tracking</p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Inactive categories cannot be used in new transactions. Existing transactions are not affected.
                </p>
              </div>
            </div>
          </div>

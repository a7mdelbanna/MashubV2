...
export default function EditContactPage({ params }: { params: { id: string } }) {
    ...
    const fetchContact = async () => {
      ...
      try {
        ...
        const mockContact = {
          ...
          shippingAddress: '',
          notes: 'Primary landlord for Cairo office space.',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/finance/contacts/${params.id}`)
    } catch (error) {
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        <Link
          href={`/dashboard/finance/contacts/${params.id}`}
        ...
        <div className="mb-6 bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-yellow-300">
              <p>
                <strong className="text-yellow-400">Note:</strong> Changing contact information will not affect existing transactions. Historical transaction records remain unchanged.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Inactive contacts cannot be used in new transactions
                </p>
              </div>
            </div>
          </div>
